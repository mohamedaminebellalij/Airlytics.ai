...
export const mockDestinations: Destination[] = [
  ...
  { iata:'CMN', city:'Marrakech',    country:'Maroc',       region:'Afrique',   price:142,  qualityScore:84, weather:'Ensoleillé',  weatherIcon:'☀️',  temperature:28, trend:'BUY',  priceHistory:generatePriceHistory(142,30), tags:['Médina','Souks','Gastronomie'], lat:31.6,  lng:-8.0 },
